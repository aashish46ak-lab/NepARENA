...
type Tab = "overview" | "organizers" | "invites" | "users";
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        {tab === "overview" && (
          <div className="mt-8 grid gap-6 lg:grid-cols-5">
            <div className="space-y-6 lg:col-span-3">
              <Section title="Platform health" desc="Relative scale across core metrics">
            ...
            <div className="space-y-6 lg:col-span-2">
              <Section title="Quick actions">
                <div className="grid gap-2">
                  <QuickLink to="/dashboard" label="eFootball Nepal dashboard" />
                  <QuickLink to="/o/efootball-nepal" label="eFN public page" />
                  <QuickLink to="/organizers" label="Organizers directory" />
                  <QuickLink to="/users" label="All registered users" />
          ...
          <div className="mt-8 space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-sm text-neutral-500">Activate, verify, suspend, or open public pages</p>
              </div>
              <div className="relative w-full sm:w-72">
                <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-neutral-500" />
                <Input className="pl-9" placeholder="Search name, slug, email…" value={query} onChange={(e) => setQuery(e.target.value)} />
              </div>
            </div>
            <div className="overflow-hidden rounded-2xl border border-white/10">
                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-xs text-neutral-500">
                        @{o.slug}{o.contact_email ? ` · ${o.contact_email}` : ""}
                      </p>
                    </div>
                  </div>
              ...
              {!filteredOrgs.length && (
                <p className="p-6 text-sm text-neutral-500">No organizers match. Run SQL 11–13 if the list is empty.</p>
              )}
            </div>
          </div>
        )}
        ...
        {tab === "invites" && (
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <Section title="Invite organizer" desc="They open the link, create their workspace, get the same dashboard template.">
              <div className="space-y-3">
                <Input placeholder="Organizer name (e.g. Pokhara eFootball)" value={name} onChange={(e) => setName(e.target.value)} />
                ...
                {lastInviteLink && (
                  <div className="rounded-xl border border-white/10 bg-white/[0.03] p-3 text-xs">
                    ...
                    <div className="flex items-start gap-2">
                      <Link2 className="mt-0.5 h-3.5 w-3.5 shrink-0 text-neutral-500" />
        ...
        {tab === "users" && (
          <div className="mt-8">
            <Section title="Latest registered users" desc="Full directory also on the public Followers page">
              <div className="overflow-hidden rounded-2xl border border-white/10">
                {(stats?.recentUsers ?? []).map((u) => (
