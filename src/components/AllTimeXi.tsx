...
export const LEGEND_PLAYERS: PlayerDef[] = [
  ...
  { name: "Bobby Moore", positions: ["CB"], overall: 93, color: "from-white/30 to-slate-800" },
  ...
  { name: "Sócrates", positions: ["AMF", "CMF"], overall: 92, color: "from-yellow-400 to-emerald-800" },
  { name: "Romário", positions: ["CF"], overall: 94, color: "from-yellow-400 to-emerald-800" },
  { name: "Rivaldo", positions: ["AMF", "LWF", "SS"], overall: 92, color: "from-yellow-400 to-emerald-800" },
  { name: "Roberto Baggio", positions: ["SS", "AMF", "CF"], overall: 93, color: "from-sky-500 to-black" },
  { name: "Hristo Stoichkov", positions: ["LWF", "CF", "SS"], overall: 91, color: "from-red-600 to-white/20" },
  { name: "Gabriel Batistuta", positions: ["CF"], overall: 91, color: "from-purple-600 to-slate-900" },
  { name: "Andriy Shevchenko", positions: ["CF"], overall: 91, color: "from-red-700 to-black" },
  { name: "Eric Cantona", positions: ["CF", "SS"], overall: 91, color: "from-red-600 to-yellow-600" },
  { name: "Alan Shearer", positions: ["CF"], overall: 90, color: "from-black to-white/20" },
  { name: "Dennis Bergkamp", positions: ["SS", "AMF", "CF"], overall: 92, color: "from-red-600 to-white/20" },
  { name: "Ruud van Nistelrooy", positions: ["CF"], overall: 90, color: "from-red-600 to-yellow-600" },
  { name: "Ruud Gullit", positions: ["AMF", "CMF", "CF"], overall: 93, color: "from-orange-500 to-red-900" },
  { name: "Frank Rijkaard", positions: ["DMF", "CB", "CMF"], overall: 91, color: "from-orange-500 to-red-900" },
  { name: "Raúl", positions: ["CF", "SS"], overall: 91, color: "from-white/40 to-slate-800" },
  { name: "Francesco Totti", positions: ["SS", "AMF", "CF"], overall: 92, color: "from-yellow-500 to-red-800" },
  { name: "Alessandro Del Piero", positions: ["SS", "CF", "AMF"], overall: 92, color: "from-black to-white/20" },
  ...
  { name: "Michael Ballack", positions: ["CMF", "AMF"], overall: 90, color: "from-red-600 to-white/20" },
  ...
  { name: "Ryan Giggs", positions: ["LWF", "LMF", "AMF"], overall: 90, color: "from-red-600 to-yellow-600" },
  ...
  { name: "Gerard Piqué", positions: ["CB"], overall: 90, color: "from-sky-500 to-red-700" },
  ...
  { name: "Petr Čech", positions: ["GK"], overall: 91, color: "from-blue-600 to-slate-900" },
  { name: "Peter Schmeichel", positions: ["GK"], overall: 92, color: "from-red-600 to-yellow-600" },
  { name: "Edwin van der Sar", positions: ["GK"], overall: 91, color: "from-red-600 to-yellow-600" },
  { name: "Dino Zoff", positions: ["GK"], overall: 92, color: "from-sky-500 to-emerald-800" },
  { name: "Philipp Lahm", positions: ["RB", "LB", "DMF"], overall: 92, color: "from-red-600 to-white/20" },
  { name: "Bastian Schweinsteiger", positions: ["CMF", "DMF"], overall: 90, color: "from-red-600 to-white/20" },
  { name: "Toni Kroos", positions: ["CMF", "DMF"], overall: 91, color: "from-white/40 to-slate-800" },
  { name: "Thomas Müller", positions: ["SS", "AMF", "CF"], overall: 90, color: "from-red-600 to-white/20" },
  ...
  { name: "Cesc Fàbregas", positions: ["CMF", "AMF"], overall: 89, color: "from-red-600 to-white/20" },
  { name: "David Silva", positions: ["AMF", "CMF", "LWF"], overall: 90, color: "from-sky-400 to-slate-800" },
  { name: "Yaya Touré", positions: ["DMF", "CMF"], overall: 90, color: "from-sky-400 to-slate-800" },
  ...
  { name: "Mesut Özil", positions: ["AMF"], overall: 89, color: "from-red-600 to-white/20" },
  { name: "James Rodríguez", positions: ["AMF", "RWF"], overall: 88, color: "from-yellow-500 to-blue-900" },
  { name: "Ángel Di María", positions: ["RWF", "LWF", "AMF"], overall: 90, color: "from-sky-500 to-indigo-900" },
  ...
  { name: "Fernando Torres", positions: ["CF"], overall: 89, color: "from-red-600 to-red-950" },
  { name: "David Villa", positions: ["CF", "LWF"], overall: 90, color: "from-sky-500 to-red-700" },
  ...
  { name: "Thiago Silva", positions: ["CB"], overall: 90, color: "from-blue-600 to-slate-900" },
  { name: "John Terry", positions: ["CB"], overall: 90, color: "from-blue-600 to-slate-900" },
  { name: "Rio Ferdinand", positions: ["CB"], overall: 90, color: "from-red-600 to-yellow-600" },
  { name: "Nemanja Vidić", positions: ["CB"], overall: 90, color: "from-red-600 to-yellow-600" },
  { name: "Marcel Desailly", positions: ["CB", "DMF"], overall: 91, color: "from-blue-500 to-white/20" },
  { name: "Lilian Thuram", positions: ["CB", "RB"], overall: 90, color: "from-blue-500 to-white/20" },
  { name: "Javier Zanetti", positions: ["RB", "LB", "CMF"], overall: 90, color: "from-blue-700 to-black" },
  ...
  { name: "Ashley Cole", positions: ["LB"], overall: 90, color: "from-blue-600 to-slate-900" },
  { name: "Patrice Evra", positions: ["LB"], overall: 88, color: "from-red-600 to-yellow-600" },
  ...
  { name: "Keylor Navas", positions: ["GK"], overall: 89, color: "from-white/40 to-slate-800" },
  { name: "Hugo Lloris", positions: ["GK"], overall: 89, color: "from-white/30 to-slate-800" },
  { name: "Jan Oblak", positions: ["GK"], overall: 91, color: "from-red-600 to-white/20" },
  { name: "Marc-André ter Stegen", positions: ["GK"], overall: 90, color: "from-sky-500 to-red-700" },
  { name: "Bruno Fernandes", positions: ["AMF", "CMF"], overall: 90, color: "from-red-600 to-yellow-600" },
  ...
  { name: "Joshua Kimmich", positions: ["DMF", "RB", "CMF"], overall: 90, color: "from-red-600 to-white/20" },
  { name: "Frenkie de Jong", positions: ["CMF", "DMF"], overall: 89, color: "from-sky-500 to-red-700" },
  { name: "Bernardo Silva", positions: ["AMF", "RWF", "CMF"], overall: 90, color: "from-sky-400 to-slate-800" },
  { name: "Marco Verratti", positions: ["CMF", "DMF"], overall: 89, color: "from-blue-600 to-red-700" },
  { name: "Paul Pogba", positions: ["CMF", "AMF"], overall: 88, color: "from-red-600 to-yellow-600" },
  { name: "Antoine Griezmann", positions: ["SS", "CF", "AMF"], overall: 90, color: "from-red-600 to-white/20" },
  { name: "Phil Foden", positions: ["AMF", "LWF", "CMF"], overall: 89, color: "from-sky-400 to-slate-800" },
  { name: "Bukayo Saka", positions: ["RWF", "LWF"], overall: 89, color: "from-red-600 to-white/20" },
  { name: "Rodrygo", positions: ["RWF", "LWF", "CF"], overall: 88, color: "from-white/40 to-slate-800" },
  { name: "Lamine Yamal", positions: ["RWF"], overall: 88, color: "from-sky-500 to-red-700" },
  { name: "Jamal Musiala", positions: ["AMF", "CMF", "LWF"], overall: 89, color: "from-red-600 to-white/20" },
  { name: "Victor Osimhen", positions: ["CF"], overall: 89, color: "from-sky-500 to-emerald-800" },
  { name: "Rafael Leão", positions: ["LWF", "CF"], overall: 88, color: "from-red-700 to-black" },
  { name: "Marcus Rashford", positions: ["LWF", "CF"], overall: 88, color: "from-red-600 to-yellow-600" },
  { name: "Raheem Sterling", positions: ["LWF", "RWF"], overall: 88, color: "from-sky-400 to-slate-800" },
  { name: "Leroy Sané", positions: ["LWF", "RWF"], overall: 88, color: "from-red-600 to-white/20" },
  { name: "Kingsley Coman", positions: ["LWF", "RWF"], overall: 88, color: "from-red-600 to-white/20" },
  { name: "Serge Gnabry", positions: ["RWF", "LWF"], overall: 87, color: "from-red-600 to-white/20" },
  { name: "Kai Havertz", positions: ["AMF", "CF", "SS"], overall: 88, color: "from-red-600 to-white/20" },
  { name: "Riyad Mahrez", positions: ["RWF", "AMF"], overall: 88, color: "from-sky-400 to-slate-800" },
  { name: "Achraf Hakimi", positions: ["RB", "RWB"], overall: 88, color: "from-blue-600 to-red-700" },
  { name: "Trent Alexander-Arnold", positions: ["RB"], overall: 89, color: "from-red-600 to-red-950" },
  { name: "Andrew Robertson", positions: ["LB"], overall: 88, color: "from-red-600 to-red-950" },
  { name: "Rúben Dias", positions: ["CB"], overall: 90, color: "from-sky-400 to-slate-800" },
  { name: "Mats Hummels", positions: ["CB"], overall: 88, color: "from-yellow-500 to-black" },
  { name: "Raphaël Varane", positions: ["CB"], overall: 89, color: "from-red-600 to-yellow-600" },
  { name: "Leonardo Bonucci", positions: ["CB"], overall: 89, color: "from-black to-white/20" },
  { name: "Giorgio Chiellini", positions: ["CB"], overall: 90, color: "from-black to-white/20" },
  { name: "Vincent Kompany", positions: ["CB"], overall: 89, color: "from-sky-400 to-slate-800" },
  { name: "Edinson Cavani", positions: ["CF"], overall: 89, color: "from-red-600 to-yellow-600" },
  { name: "Paulo Dybala", positions: ["SS", "AMF", "CF"], overall: 89, color: "from-black to-white/20" },
  { name: "Lautaro Martínez", positions: ["CF"], overall: 89, color: "from-blue-700 to-black" },
  { name: "Romelu Lukaku", positions: ["CF"], overall: 88, color: "from-blue-700 to-black" },
  { name: "Pierre-Emerick Aubameyang", positions: ["CF", "LWF"], overall: 88, color: "from-red-600 to-white/20" },
  { name: "Ousmane Dembélé", positions: ["RWF", "LWF"], overall: 88, color: "from-sky-500 to-red-700" },
  { name: "Marco Reus", positions: ["AMF", "LWF", "SS"], overall: 88, color: "from-yellow-500 to-black" },
  { name: "Declan Rice", positions: ["DMF", "CMF"], overall: 88, color: "from-red-600 to-white/20" },
  { name: "Martin Ødegaard", positions: ["AMF", "CMF"], overall: 88, color: "from-red-600 to-white/20" },
  { name: "Pedri", positions: ["CMF", "AMF"], overall: 88, color: "from-sky-500 to-red-700" },
  { name: "Gavi", positions: ["CMF", "DMF"], overall: 87, color: "from-sky-500 to-red-700" },
];
