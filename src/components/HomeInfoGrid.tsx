...
const CARDS = [
  {
    ...
    description: "Learn about our journey, purpose and vision.",
    icon: Info,
  ...
  },
  {
    ...
    description: "Know the rules that keep NepARENA fair and safe.",
    icon: Scale,
  ...
  },
  {
    to: "/news" as const,
    title: "News",
    description: "Latest updates and announcements from NepARENA.",
    icon: Newspaper,
  ...
  },
  {
    to: "/guides" as const,
    title: "Guides",
    description: "Helpful guides for players, tournaments and the community.",
    icon: BookOpen,
