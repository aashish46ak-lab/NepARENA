...
function MemberProfilePage() {
  ...
  return (
    <PageShell force="platform" hideChrome>
      <div className="mx-auto w-full max-w-md px-3 pb-24 pt-3 sm:max-w-2xl sm:px-4 md:max-w-3xl lg:max-w-4xl lg:px-6">
          ...
          <div className="relative px-4 pb-5">
            ...
            <div className="mt-3 flex flex-wrap gap-4 text-sm text-neutral-400">
              <Link
                to="/followers/$id"
                params={{ id }}
                className="rounded-lg px-1 py-0.5 transition hover:bg-white/[0.06] hover:text-white active:scale-[0.98]"
              >
              ...
              <Link
                ...
                className="rounded-lg px-1 py-0.5 transition hover:bg-white/[0.06] hover:text-white active:scale-[0.98]"
              >
                <strong className="tabular-nums text-white">{followingCount}</strong> following
              </Link>
            </div>
