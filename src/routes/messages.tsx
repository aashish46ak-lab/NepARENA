          ...
          >
            ...
            <section
              className={cn(
                ...
                !mobileChat && "hidden md:flex",
                mobileChat &&
                  "fixed inset-0 z-[100] flex h-[100dvh] max-h-[100dvh] w-full animate-in slide-in-from-right duration-200 md:static md:z-auto md:h-auto md:max-h-none md:animate-none",
              )}
            >
              {!activeThread ? (
