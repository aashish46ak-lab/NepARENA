    ...
    <PageShell>
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center">
          <div className="text-6xl md:text-7xl font-bold text-gradient-brand">
            {count}
          </div>
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {members.map((m) => (
            <Link
              ...
              to="/members/$id"
              params={{ id: m.id }}
              className="glass rounded-xl p-4 flex items-center gap-3 hover:bg-accent/20 transition"
            >
